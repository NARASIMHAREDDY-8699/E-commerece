...
import razorpay
razorpay_key_id ="rzp_test_m6UcKrY3pnYfZ4"
razorpay_key_secret ="qOYPzcubClVlY3c3O5rkLl8y"
...
def registerdata():
    if request.method == "POST":
        ...
        if password == cpassword:
            ...
            smtp_port = 587
            mailusername = "narasimhareddytadipathi123@gmail.com"
            mailpassword="lukk wkdh bclw cppf"
            from_email = "narasimhareddytadipathi123@gmail.com"
            to_email = email
        ...
        return "<h3 sytle='color:red'>Data got in wrong manner</h3>"
    ...
    if request.method == "POST":
        ...
        if otp == verifyotp:
            try:
                ...
                return "Error Occured while storing data in database"
            else:
                return render_template("login.html")
        else:
            return "Wrong otp"
